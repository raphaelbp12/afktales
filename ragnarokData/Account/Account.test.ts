...
describe("Account", () => {
    ...
    it("should initialize with an empty characters array and a storage with capacity 1000", () => {
        ...
        expect(account.getStorage().items.length).toBe(1000);
    });
    ...
    describe("getCharacter", () => {
        ...
        it("should throw an error if index is out of bounds", () => {
            expect(() => account.getCharacter(0)).toThrow("Character index 0 out of bounds");
            expect(() => account.getCharacter(-1)).toThrow("Character index -1 out of bounds");
        });
    });
    ...
    describe("removeCharacter", () => {
        ...
        it("should throw an error if trying to remove a character from an empty array", () => {
            expect(() => account.removeCharacter(0)).toThrow("Character index 0 out of bounds");
        });

        it("should throw an error if index is out of bounds", () => {
            account.newCharacter("Char1");
            expect(() => account.removeCharacter(1)).toThrow("Character index 1 out of bounds");
            expect(() => account.removeCharacter(-1)).toThrow("Character index -1 out of bounds");
        });
    });
});
